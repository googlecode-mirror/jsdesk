    ...
    getToolButton : function(config){
    	var btn = new Ext.Button({
			...
			template: new Ext.Template(
				...
				'<td class="ux-startmenu-tool-left"><i>&#160;</i></td><td class="ux-startmenu-tool-center"><em unselectable="on"><button class="x-btn-text" type="{1}" style="height:27px;">{0}</button></em></td><td class="ux-startmenu-tool-right"><i>&#160;</i></td>',
				'</tr></tbody></table>')
		});
